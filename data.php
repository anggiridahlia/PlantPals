...
// Contoh ID Kategori dari tabel `categories` Anda. Anda harus menyesuaikan ini!
// Dapatkan ID ini dari database Anda setelah mengisi tabel `categories`.
$CATEGORY_ID_BUNGA = 4; // Contoh ID untuk 'BUNGA'
$CATEGORY_ID_ALAT_BAHAN = 3; // Contoh ID untuk 'ALAT DAN BAHAN MENANAM'
$CATEGORY_ID_LAINNYA = 5; // Contoh ID untuk 'LAINNYA'
$CATEGORY_ID_BUAH = 1; // Contoh ID untuk 'BUAH'
$CATEGORY_ID_SAYUR = 2; // Contoh ID untuk 'SAYUR'
...
$flowers_initial_data = [
    [
        ...
        "price" => 75000, "stock" => 10, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA // Tambah ini
    ],
    // ... produk bunga lainnya ...
    [
      ...
      "price" => 120000, "stock" => 5, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 85000, "stock" => 15, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 95000, "stock" => 8, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 60000, "stock" => 20, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_LAINNYA // Atau buat CATEGORY_ID_TANAMAN_HIAS
    ],
    [
      ...
      "price" => 70000, "stock" => 12, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 110000, "stock" => 7, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 130000, "stock" => 6, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 40000, "stock" => 25, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 100000, "stock" => 9, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 65000, "stock" => 18, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 180000, "stock" => 3, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 55000, "stock" => 14, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 80000, "stock" => 10, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 140000, "stock" => 5, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 105000, "stock" => 7, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 90000, "stock" => 11, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 170000, "stock" => 4, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 60000, "stock" => 16, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 50000, "stock" => 13, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 45000, "stock" => 22, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 125000, "stock" => 8, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ],
    [
      ...
      "price" => 200000, "stock" => 2, "seller_id" => $DEFAULT_FALLBACK_SELLER_ID, "category_id" => $CATEGORY_ID_BUNGA
    ]
    ];
    ...
    $other_products_initial_data = [
        [
            ...
            "category_id" => $CATEGORY_ID_ALAT_BAHAN // Tambah ini
        ],
        [
