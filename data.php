...
// Data bunga dalam array PHP (digunakan untuk tampilan awal sebelum terhubung ke DB)
// Serta data toko yang bisa dipilih
$flowers_initial_data = [ // Renamed to avoid conflict when fetching from DB
    [
        "name" => "Pink Rose",
        "img" => "assets/rose.jpg",
        "scientific" => "Rosa",
...
// Data toko dummy (ini tetap hardcoded karena tidak ada tabel 'stores' di DB contoh)
$stores = [
    ["id" => "toko1", "name" => "Toko Bunga Sejuk Asri", "address" => "Jl. Raya Puputan No. 100, Denpasar"],
    ["id" => "toko2", "name" => "Flora Indah Bali", "address" => "Jl. Sunset Road No. 50, Kuta"],
    ["id" => "toko3", "name" => "Green Harmony Garden", "address" => "Jl. Garuda No. 25, Ubud"]
];

// Anda juga bisa menambahkan produk non-bunga lainnya secara hardcode di sini
$other_products_initial_data = [
    [
        "name" => "Pot Tanah Liat Klasik",
        "img" => "assets/pot_tanah.jpg",
    ...
    [
        "name" => "Pupuk Organik Serbaguna",
        "img" => "assets/pupuk.jpg",
    ...
    [
        "name" => "Set Alat Kebun Mini",
        "img" => "assets/alat_kebun.jpg",
...
// Gabungkan semua data produk untuk penggunaan di frontend yang tidak dari DB
